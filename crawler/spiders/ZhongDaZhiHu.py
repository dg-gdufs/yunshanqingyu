...
# from Tieba_2.items import ZhiHuItem
# import json

# # author:陈宣齐 2022.1.22
# class ZhongDaZhiHuSpider(scrapy.Spider):
#     name = 'ZhongDaZhiHu'
#     # allowed_domains = ['tieba.baidu']
#     start_urls = ['https://www.zhihu.com/topic/19608566/index']
#     school_id = 2
#     sql = {
#         'table': 'zhihu',
#         'host': 'localhost',
...
#             }
#             yield scrapy.Request(url='https://www.zhihu.com'+i.find('a').get('href'),callback=self.parse_2,meta=meta)
...
#             }
#             data_url = 'https://www.zhihu.com/api/v4/questions/{}/answers?include=data%5B%2A%5D.is_normal%2Cadmin_closed_comment%2Creward_info%2Cis_collapsed%2Cannotation_action%2Cannotation_detail%2Ccollapse_reason%2Cis_sticky%2Ccollapsed_by%2Csuggest_edit%2Ccomment_count%2Ccan_comment%2Ccontent%2Ceditable_content%2Cattachment%2Cvoteup_count%2Creshipment_settings%2Ccomment_permission%2Ccreated_time%2Cupdated_time%2Creview_info%2Crelevant_info%2Cquestion%2Cexcerpt%2Cis_labeled%2Cpaid_info%2Cpaid_info_content%2Crelationship.is_authorized%2Cis_author%2Cvoting%2Cis_thanked%2Cis_nothelp%2Cis_recognized%3Bdata%5B%2A%5D.mark_infos%5B%2A%5D.url%3Bdata%5B%2A%5D.author.follower_count%2Cvip_info%2Cbadge%5B%2A%5D.topics%3Bdata%5B%2A%5D.settings.table_of_content.enabled&limit=5&offset=0&platform=desktop&sort_by=default'.format(response.meta['question_id'])
...
#                 item['user_id'] = '匿名用户'
#             item['answer_id'] = i['id']
#             item['thumb_up'] = i['voteup_count']
#             item['comments'] = i['comment_count']
...
#                 comments_url = 'https://www.zhihu.com/api/v4/answers/{}/root_comments?limit=10&offset=0&order=normal&status=open'.format(i['id'])
#                 meta = {
...
#             item['thumb_up'] = i['vote_count']
#             item['comments'] = i['child_comment_count']
